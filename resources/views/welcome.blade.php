...
<body class="h-100">
    <div class="container h-100 w-25">
        <div class="row justify-content-center h-100 align-content-center">
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Sign In!</h1>
            <form action="{{ url()->current() }}" method="POST">
                ...
                <div class="flex items-start mb-6">
                    ...
                    <input name="remember" id="remember" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required />
                    </div>
